...
\Satz Konvergente Folge besitzt genau einen Grenzwert
...
\begin{itemize}
    ...
    \item $\lim\limits_{n\to\infty} n^\frac{1}{n} = \lim\limits_{n\to\infty} \sqrt[n]{n} = 1$
    \item $\lim\limits_{n\to\infty} x^\frac{1}{n} = \lim\limits_{n\to\infty} \sqrt[n]{x} = 1$, $x > 0$
    \item $\forall x \in \RR : \lim\limits_{n\to\infty} (1 + \frac{x}{n})^n = e^x$
    \item $\forall x \in \RR : \lim\limits_{n\to\infty} \frac{x^n}{n!} = 0$
\end{itemize}

\Satz $\star$ Für grosse $x \in \RR$ resp. $n \in \NN$, $a, p \in \RR$, $a > 1$, $p > 0$:
$$\ln(\ln x) \ll \ln x \ll x^p \ll a^x \ll n! \ll n^n$$

\Satz $\star$ \key{Stirling-Formel}: Für grosse $n \in \NN$ gilt die Näherung
...
\begin{itemize}
    ...
    \item beschr. Folge konvergiert gdw $\limsup\limits_{n\to\infty} a_n = \liminf\limits_{n\to\infty} a_n$;
    dann gilt $\lim\limits_{n\to\infty} a_n = \limsup\limits_{n\to\infty} a_n = \liminf\limits_{n\to\infty} a_n$
\end{itemize}
