...
\vspace{-0.6em}
\begin{itemize}
    \item Jede Potenzreihe hat \key{Konvergenzradius} $R$. Reihe konvergiert absolut für $|x-a| < R$, divergiert für $|x-a| > R$ (gilt genauso für $x, a, c_k \in \CC$)
...
\Satz $\star$ $(a_n)_{n\in\NN_0}$ Folge komplexer Zahlen mit $a_n \ne 0$ für fast alle $n$ und
