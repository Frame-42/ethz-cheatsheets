...
\begin{itemize}
    ...
    \item $(1 + x)^\alpha = \sum_{k=0}^{\infty} \begin{pmatrix}\alpha \\ k\end{pmatrix} x^k$, $\alpha \in \RR$, wobei $\begin{pmatrix}\alpha \\ k\end{pmatrix} = \frac{\alpha(\alpha-1)\cdots(\alpha-k+1)}{k!}$ für $|x| < 1$
\end{itemize}
